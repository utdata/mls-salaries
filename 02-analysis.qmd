...
- Who do team salary rankings compare over time?
...
For all player, all time. This is based on compensation. Printing search able table.
...
- I'm removing players not affiliated with times
...
Visualizing all of them would be tricky. Let's do the top five over last five years. Some other trickyness:
