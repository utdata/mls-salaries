...
- We are starting with some historical data already cleaned by Jeremy Singer-Vine for the Data is Plural newsletter: [Github archive](https://github.com/data-is-plural/mls-salaries). It goes from 2007 to 2017.
  + It's interesting that the DIP PDF for 2017 is different than what I downloaded from the MLSPA site. It appears to have pool MLS players but mine does not.
...
- The 2022 and 2023 data comes as Excel files.
...
- I wanted add conference affiliations, which I did manually in the Google Sheet reference.

### Things to do

- I need to double-check all the conference designations.
